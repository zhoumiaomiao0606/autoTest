...
public class LoanProcessCollectionServiceImpl implements LoanProcessCollectionService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LoanProcessCollectionServiceImpl.class);
...
//        createRepayPlan(approval.getTaskDefinitionKey(), loanProcessDO, loanOrderDO);
        ...
        // [领取]完成
        finishTask(approval, startTaskIdList, loanProcessDO.getProcessInstId());
...
//            }
     ...
     * @param reason
     */
    private void createRejectLog(List<Task> newTaskList, LoanProcessCollectionDO loanProcessDO, String rejectOriginTask, String reason) {
