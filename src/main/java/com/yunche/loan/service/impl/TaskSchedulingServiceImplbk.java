...
@Service
public class TaskSchedulingServiceImplbk implements TaskSchedulingService {
...
//        } else
            ...
            if (LoanProcessEnum.TELEPHONE_VERIFY.getCode().equals(taskDefinitionKey) || LoanProcessEnum.FINANCIAL_SCHEME_MODIFY_APPLY_REVIEW.getCode().equals(taskDefinitionKey)) {
            Long telephoneVerifyLevel = taskSchedulingDOMapper.selectTelephoneVerifyLevel(loginUser.getId());
            taskListQuery.setTelephoneVerifyLevel(telephoneVerifyLevel);
        ...
        } else if (LoanProcessEnum.BANK_LEND_RECORD.getCode().equals(taskDefinitionKey)) {
...
//
//        } else
        if (LoanProcessEnum.TELEPHONE_VERIFY.getCode().equals(taskDefinitionKey)) {
