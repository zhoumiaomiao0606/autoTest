...
public interface TestFeign {
    ...
    public boolean query(@Validated @NotNull @RequestBody ICBCApiCallbackParam.Callback callback);



    @PostMapping(value = "/api/v1/loanorder/icbc/term", consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public boolean term(@Validated @NotNull @RequestBody ICBCApiCallbackParam.Callback callback);
}
