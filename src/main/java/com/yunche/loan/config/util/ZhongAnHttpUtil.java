...
public class ZhongAnHttpUtil {
    ...
    public static Map queryInfo(String name,String tel,String idcard,String appNo,String loanPeriod,String appRole,String ralationship,String applyNo) throws Exception {
      ...
      //测试  String appKey ="dea30205f1356f6d3c99d2a46b786705";
//  测试      String privatekey = "MIICdQIBADANBgkqhkiG9w0BAQEFAASCAl8wggJbAgEAAoGBALtzmprQXmbomt9i" +
...
//测试        ZhongAnApiClient client = new ZhongAnApiClient("dev", appKey, privatekey, "1.0.0");
        ...
        //测试 param.put("merchKey","ADC91A4D994891CCBD386B33674EF682");
