...
import com.yunche.loan.tools.JsonUtil;
                ...
                public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
                    ...
                    if (pass) {
                        ...
                        logger.warn("签名认证失败，请求接口：{}，请求IP：{}，请求参数：{}",
                                request.getRequestURI(), getIpAddress(request), JsonUtil.objToJson(request.getParameterMap()));
                        throw new ServiceException(ExceptionEnum.EA00000001);
                    }
                }
            });
        }
