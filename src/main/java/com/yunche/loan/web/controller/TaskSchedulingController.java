...
public class TaskSchedulingController {
    ...
    public ResultBean scheduleTaskList(@RequestParam Integer startRow, @RequestParam Integer pageSize) {
        return taskSchedulingService.scheduleTaskList(startRow,pageSize);
    }
