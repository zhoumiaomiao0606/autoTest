...
//        bankSolutionService.multimediaUpload(Long.parseLong(param.getOrderId()));
     ...
     * @return
     */
    @GetMapping(value = "/applyMediaStatus")
    public ResultBean applyMediaStatus(@RequestParam("orderId") Long orderId) {
        return ResultBean.ofSuccess(bankSolutionService.applyMediaStatus(orderId));
    }
