...
public class CustRelaPersonInfoVO implements Serializable {
    ...
    public Long getRelaCustId() {
        return relaCustId;
    }

    public void setRelaCustId(Long relaCustId) {
        this.relaCustId = relaCustId;
    }

    public String getRelaCustType() {
        return relaCustType;
    }

    public void setRelaCustType(String relaCustType) {
        this.relaCustType = relaCustType == null ? null : relaCustType.trim();
    }
